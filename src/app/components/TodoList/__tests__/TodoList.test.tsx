...
describe("TodoList", () => {
  it('should render "No Todos Available" when the array is empty', () => {
    ...
    const message = screen.getByText("No Todos Available"); //ACT
  ...
  it("should render a list with the correct number of items", () => {
    ...
    const todosArray = screen.getAllByRole("article"); //ACT
  ...
  it("should render the todos in the correct order", () => {
    ...
    const firstItem = screen.getAllByTestId("todo-item")[0]; //ACT
